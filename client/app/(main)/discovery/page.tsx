  ...
  return (
    <div className="flex h-full w-full overflow-hidden animate-in fade-in duration-500">
      ...
      <aside className="w-[30%] min-w-[420px] bg-white z-20 flex flex-col border-r border-outline/10 shadow-2xl shadow-black/5">
        <div className="p-8 space-y-8 flex-1 overflow-y-auto hide-scrollbar">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <h1 className="text-4xl font-black tracking-tighter text-on-surface">Discovery Archive</h1>
              <div className="w-11 h-11 rounded-2xl bg-surface-container-high flex items-center justify-center border border-outline/5 hover:bg-primary/5 transition-colors cursor-pointer">
                <span className="material-symbols-outlined text-primary text-xl">tune</span>
              </div>
            </div>
            <p className="text-outline text-[10px] font-black uppercase tracking-widest">Unveil 1,000 years of heritage layers.</p>
          </div>
          ...
          <div className="space-y-4">
              <label className="font-label text-[10px] font-black uppercase tracking-widest text-outline block">Featured Districts</label>
              <div className="flex flex-wrap gap-2">
                <button className="px-5 py-2.5 bg-primary text-white rounded-full text-[10px] font-black uppercase tracking-widest shadow-lg shadow-primary/20 transition-all">Hoan Kiem</button>
                <button className="px-5 py-2.5 bg-surface-container-high text-outline rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-primary/10 hover:text-primary transition-all">Ba Dinh</button>
                <button className="px-5 py-2.5 bg-surface-container-high text-outline rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-primary/10 hover:text-primary transition-all">Tay Ho</button>
              </div>
          </div>
          ...
          <div className="space-y-5 pt-4">
            <div className="flex items-center justify-between">
              <label className="font-label text-[10px] font-black uppercase tracking-widest text-outline block">Heritage Collection</label>
              <button className="text-[10px] font-black text-primary hover:underline uppercase tracking-widest">View All</button>
            </div>

            {/* Heritage Card 1 */}
            <div className="group cursor-pointer bg-surface-container-lowest border border-outline/5 hover:border-primary/20 p-4 rounded-[2rem] shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 flex gap-4">
              ...
              <div className="flex flex-col justify-between py-1">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <p className="text-xs text-outline font-black uppercase tracking-tighter">Hoan Kiem • Heritage</p>
                  </div>
                </div>
                <div className="px-3 py-1 bg-secondary-container/30 text-primary text-[9px] font-black rounded-lg w-fit uppercase tracking-widest">1,000+ Visited</div>
              </div>
            </div>
            ...
            <div className="group cursor-pointer bg-surface-container-lowest border border-outline/5 hover:border-primary/20 p-4 rounded-[2rem] shadow-sm hover:shadow-xl hover:shadow-primary/5 transition-all duration-500 flex gap-4">
              ...
              <div className="flex flex-col justify-between py-1">
                <div className="space-y-1">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="material-symbols-outlined text-[14px] text-outline">location_on</span>
                    <p className="text-xs text-outline font-black uppercase tracking-tighter">Hoan Kiem • Scenic</p>
                  </div>
                </div>
                <div className="px-3 py-1 bg-green-50 text-green-700 text-[9px] font-black rounded-lg w-fit uppercase tracking-widest">Open now</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 bg-surface-container-low border-t border-outline/10 text-center">
             <p className="text-[10px] font-black text-outline uppercase tracking-widest mb-4">Start your own story</p>
             <button className="w-full py-4 bg-primary text-white rounded-2xl font-black shadow-lg shadow-primary/20 hover:scale-[1.01] active:scale-[0.99] transition-all uppercase tracking-widest text-[10px]">Create New Trip</button>
        </div>
      </aside>
