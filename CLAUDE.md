...
- **`Reports/HanoiGO-report.tex` is FROZEN.** The report has already been submitted — do not edit this file for any reason. If a discrepancy between the report and the code is found, report it to the user instead of changing the file.
